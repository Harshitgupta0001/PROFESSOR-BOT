...
🔊Just SEND A MOVIE MAME AMD BOOM U GOT """
    
    HELP_TXT = "Hᴇʏ {}\nHᴇʀᴇ Mꜱ Mʏ Hᴇʟᴩ"

    ABOUT_TXT = """<b>✯ Mʏ ɴᴀᴍᴇ: {}
✯ Dᴇᴠᴇʟᴏᴩᴇʀ: <a herf=https://t.me/>HaRsHiT ᴛɢ</a>
...
<b>ᴅᴇᴠ: <a herf=https://t.me/>HaRsHiT ᴛɢ</a></b>"""
...
┣ HaRsHiT 🔥
╰─────── • ◆ • ───────➤
   For SEARCH THIS MOVIE 👇👇
┣ @moviesworldsupportzone
╰─────── • ◆ • ───────➤"""
